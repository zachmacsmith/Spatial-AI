...
proximity_threshold_percent = 0.2  # 20% of frame width
    ...
    def update(self, relationships, current_frame):
        ...
        for rel_key, start_frame in self.active_relationships.items():
            if rel_key not in current_relationship_keys:
                ...
                print(f"Frame {current_frame}: Ended relationship: {set(rel_key)} (lasted {current_frame - start_frame} frames)")
...
def process_video(video_name):
    ...
    with open(relationships_csv_path, 'w') as f:
        ...
        for rel in relationships_data:
            ...
            f.write(f"{rel['start_frame']},{rel['end_frame']},{start_time:.2f},{end_time:.2f},{duration:.2f},{objects_str}\n")
